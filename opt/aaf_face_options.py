...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default = 'aaf_face' , required=False, help='name of the experiment.')
        parser.add_argument('--model',type=str,default='fedst',choices=['unet','fedst', 'fedst_ddpm'],help='chooses which model to use,unet...')
        parser.add_argument('--federated_algorithm',type=str,default='fedavg',choices=['fedavg', 'fedprox', 'feddyn', 'feddc', 'fedddpm', 'fedst_separate', 'fedst_join'],help='chooses which federated learning algrithom to use')
        ...
        parser.add_argument('--client_num_per_round', type=int, default=79, metavar='NN',help='number of workers')
        ...
        parser.add_argument('--dataroot',default= './dataset/AAF_Face',help='path to images')
        parser.add_argument('--resultroot',default= './ckpt_aaf_face_new',help='path to ckpt')
        ...
        parser.add_argument('--output_nc',type=int,default= 19, help='output classes')
        ...
        parser.add_argument('--focal_alpha', type=list, default = None, help='alpha of focal loss')
...
class TrainOptions(BaseOptions):
    def initialize(self,parser):
        ...
        # for training
        parser.add_argument('--mode', type=str, default='Train', help='Option mode')
...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        parser = BaseOptions.initialize(self, parser)
        parser.add_argument('--mode', type=str, default='Test', help='Option mode')
