...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--client_num_in_total', type=int, default=3, metavar='NN',help='number of workers in a distributed cluster')
        ...
        parser.add_argument('--dataroot',default= './dataset/Face_segment',help='path to images')
        parser.add_argument('--resultroot',default= './ckpt_face',help='path to ckpt')
