...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default = 'medical' , required=False, help='name of the experiment.')
        ...
        parser.add_argument('--dataroot',default= './dataset/CHAOS_liver',help='path to images')
