...
def define_network(logger, opt, network_opt):
    ...
    net = init_obj(network_opt, logger, default_file_name='models.fedst_ddpm_model.ddpm_models.models.network', init_type='Network')
...
def define_loss(logger, loss_opt):
    return init_obj(loss_opt, logger, default_file_name='models.fedst_ddpm_model.ddpm_models.models.loss', init_type='mae_loss')
