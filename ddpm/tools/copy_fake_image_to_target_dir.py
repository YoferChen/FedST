...
diffusion_code_dir = '/chenyongfeng/FedST/diffusion_model/Palette-Image-to-Image-Diffusion-Models-main'
result_base_dir = os.path.join(diffusion_code_dir, 'experiments/test_result_separate_0810')
json_path = os.path.join(diffusion_code_dir, 'fake_ages.json')
target_dataset_dir = '/chenyongfeng/FedST/dataset/AAF_Face_new/train/fake_image'
