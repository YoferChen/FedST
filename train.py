...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', default = 'classification', choices=['material', 'medical', 'medical_material', 'face', 'aaf_face', 'XCX'], help='which dataset to use')
    ...
    parser.add_argument('--fake_dirname', type=str, help='Fake image directory name for FedST algorithm')
    ...
    opt_test.fake_dirname = op.fake_dirname
    ...
    # 扩展实验参数
    opt_train.model_average = True  # Obtain fake images generated by aggregation models, see: data/dataset/aligned_dataset.py
    ...
    if opt_train.federated_algorithm == 'local':
        ...
        opt_train.federated_algorithm = 'fedddpm'
        opt_train._federated_algorithm = 'fake_image_join'
        trainer = FedAvgTrainer(dataset, opt_train, opt_test, log)
    else:
